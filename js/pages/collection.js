    ...
    if (heroSection) {
        if (category === 'anime') {
            if (!heroSection.querySelector('.collection-video-bg')) {
                const videoHTML = `
                    <video autoplay loop playsinline webkit-playsinline="true" disablePictureInPicture preload="auto" class="collection-video-bg" id="anime-hero-video">
                        <source src="video/anime1.mp4" type="video/mp4">
                    </video>
                    <button id="hero-mute-btn" class="hero-mute-btn" aria-label="Toggle Mute">
                        <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon-volume-on">
                            <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
                            <path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path>
                        </svg>
                        <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="icon-volume-off" style="display:none;">
                            <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
